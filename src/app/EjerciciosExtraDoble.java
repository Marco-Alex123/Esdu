...
public class EjerciciosExtraDoble<T extends Comparable<T>> {

    private int count = 0;
    private long suma = 0;
    private T maximo = null;

    public boolean SonIguales(DoubleLinkedList<T> list1, DoubleLinkedList<T> list2) {
    ...
    public int ExisteElemento(T value, DoubleLinkedList<T> list) {
        count = 0;
    ...
    public int Ocurrencia(T value, DoubleLinkedList<T> list) {
        count = 0;
    ...
    public long Suma(DoubleLinkedList<Integer> list) {
        suma = 0;
        if (list.getElementAt(0) != null)
    ...
    public T Maximo(DoubleLinkedList<T> list){
